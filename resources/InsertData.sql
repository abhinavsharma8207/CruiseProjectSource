...
FROM OPENROWSET (BULK 'C:\Users\Abhinav\Desktop\salesUnits.json', SINGLE_CLOB) as j
...
FROM OPENROWSET (BULK 'C:\Users\Abhinav\Desktop\ships.json', SINGLE_CLOB) as j
...
FROM OPENROWSET (BULK 'C:\Users\Abhinav\Desktop\bookings.json', SINGLE_CLOB) as j
